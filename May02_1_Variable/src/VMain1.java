...
public class VMain1 {
	public static void main(String[] args) {
		...
		//  => 재사용이 안됨!
		System.out.println("ㅋ"+"ㅎ"+"ㅁㄴㅇㄹㄴㅁㅇㄹ");
		...
		// 			byte : -128 ~ 127
		//			short : 약 -3만 ~ 3만
		//			int : 약 -21억 ~ 21억 (v) formatting형식 (%d)
		//			long : int를 벗어나는 범위
		// 		실수
		//			float 
		//			double (v) formatting형식 (%f)
		// 			다른 언어 : float / Java 한정 : double
		//		문자
		//			char formatting형식 (%c)
		//		논리
		//			boolean : 참 / 거짓 ( true / false ) formatting형식 (%b)
		//		없음
		//			void : '없음' (나중에 알아보자!)
		...
		// 		문자열
		//			String : 문자열(여러글자)를 저장, 앞에 대문자 S! formatting형식 (%s)
