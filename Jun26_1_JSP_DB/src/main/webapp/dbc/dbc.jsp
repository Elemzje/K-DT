<%@page import="com.minju.db.manager.MinjuDBManager"%>
...
<body>
	<%
		...
		// 기존 : DriveManager.getConnnection()을 실행하는 순간
		...
		// Servers - context.xml
		//		저걸 건들면... 워크스페이스 안에 있는 모든 프로젝트에 다 영향!!!
		//		프로젝트가 다르다 => DB서버가 다르다
		...
		MinjuDBManager.close(con, null, null);
	%>
	<h1>DB연결</h1>
	<h1><%=result %></h1>
