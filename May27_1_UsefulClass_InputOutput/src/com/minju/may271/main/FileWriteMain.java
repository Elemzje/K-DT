...
// 프로그램에서는 데이터를 외부에서 읽고, 다시 외부로 출력하는 작업이 빈번함
...
//			OutputStream : 프로그램의 결과 => 장치로 출력 (1byte) 
//			OutputStreamWriter : 2byte + 디코딩방식
...
public class FileWriteMain {
	public static void main(String[] args) {
		...
		//	Linux의 경로 : C:/Users/sdedu/Desktop/Test/minju1.txt
		//		=> /로 경로 설정
		//	Windows의 경로 : C:\\Users\\sdedu\\Desktop\\Test\\minju1.txt
		//		=> \\로 경로 설정 + / 하나로도 가능!
		//	Java의 \는 : \t, \r, \n, \0, ... (이스케이프 문자) 에 사용
		//	권한, 폴더명 오타, ... => 예외처리!
		...
		try {
			...
			// 기존에 내용 뒤에 덧붙이고 싶으면 (데이터를 추가하고 싶다면)
			// 두번째 파라미터의 값으로 true를 주면 됨
			
			// Encoding 방식지정 X => ANSI로 인코딩됨
			FileWriter fw = new FileWriter("C:\\Users\\sdedu\\Desktop\\Test/minju1.txt", true);
