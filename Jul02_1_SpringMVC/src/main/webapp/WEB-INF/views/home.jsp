...
<h1>
	...
	[jsp] - http://IP:Port/proectName/FileName
	[spring] - http://IP:Port/top-level-package의 마지막 자리
	...
	Spring 이전에
	애프리케이션 구현 => EJB(Enterprise JavaBeans)
	EJB의 기술이 점점 발전하면서 그만큼 성능이 느려지게 되고,
	기능을 추가할수록 더욱더 복잡하게 되었는데...
